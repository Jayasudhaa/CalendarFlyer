...
const P = {
  ...
  get text()   { return 'var(--cf-text-primary)' },
  get gold()   { return 'var(--cf-accent)' },
  get muted()  { return 'var(--cf-text-muted)' },
  get faint()  { return 'var(--cf-text-muted)' },
...
export default function BroadcastPage({ onClose }) {
  ...
  const card  = { background:P.card, border:`1px solid ${P.border}`, borderRadius:12, padding:'14px 16px', marginBottom:12 };
  const lbl   = { fontSize:'0.68rem', color:P.muted, fontWeight:600, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:8, fontFamily:"'Inter', system-ui, sans-serif" };
  ...
  return (
    ...
    <div style={{ position:'fixed', inset:0, zIndex:50, background:P.bg, overflowY:'auto', fontFamily:"'Inter', system-ui, sans-serif" }}>

      <div style={{ position:'sticky', top:0, zIndex:10, background:'var(--cf-header-bg)', backdropFilter:'blur(8px)', borderBottom:`1px solid ${P.border}`, padding:'12px 22px', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
