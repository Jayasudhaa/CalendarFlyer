        ...
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                <h1 style={{ fontSize:'1.4rem', fontWeight:700, color:'#6b2d0a', fontFamily:'Cinzel,Georgia,serif' }}>Settings</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Sample Temple Name"
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="123 Main Street, Your City, ST 00000"
              />
            </div>
