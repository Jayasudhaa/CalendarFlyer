...
Admin credentials are set via environment variables (`VITE_ADMIN_USERNAME`, `VITE_ADMIN_PASSWORD`, `VITE_ADMIN_SECRET`) — see `.env.example`. No credentials are hardcoded in source.
