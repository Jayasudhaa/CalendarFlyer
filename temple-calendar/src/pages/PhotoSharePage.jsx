 ...
 *  - Not verified yet: phone number -> SMS code -> verified. Token is
  ...
  return (
    <div style={{ background: '#fffdf7', borderRadius: 16, border: '1px solid #e8d5b7', padding: 28 }}>
      <div style={{ color: '#92400e', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: 20 }}>
        To view and share photos from this event, verify your phone number — this keeps the album for people who were actually there.
      </div>
