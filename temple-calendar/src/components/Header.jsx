...
function Header({ onShowLogin, onShowDashboard, onShowBroadcast, onShowFlyerStudio, onShowAnalytics, events = [], adminMode = false, onToggleAdminMode }) {
  ...
  return (
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{
            ...
            <div>
              ...
              fontSize: '1.25rem',
                fontWeight: '700',
              color: '#6b2d0a', fontFamily: "'Playfair Display', Georgia, serif",
              margin: 0,
              lineHeight: 1.2
                }}>
              {templeInfo.name}
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg,#fff8ee,#fef3e0)',
        borderTop: '1px solid #e8d5a3'
      }}>
          <div style={{ display: 'flex', gap: '1.5rem', fontSize: '0.8rem', color: '#b97a3a' }}>
          ...
          <div style={{ background: 'white', borderRadius: 16, width: '100%', maxWidth: 400, boxShadow: '0 20px 60px rgba(0,0,0,0.3)', overflow: 'hidden' }} onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleAdminLogin} style={{ padding: '24px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                />
                <p style={{ marginTop: '8px', fontSize: '0.75rem', color: '#b97a3a' }}>
