  ...
  return (
    <>
      <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: '#0f172a', display: 'flex', flexDirection: 'column', fontFamily: 'Georgia,serif' }}>
        ...
        {/* ═══ TOP TOOLBAR ═══ */}
        <div style={{ height: 58, background: '#1e293b', borderBottom: '1px solid #334155', display: 'flex', alignItems: 'center', padding: '0 12px', gap: 6, flexShrink: 0, overflowX: 'auto' }}>
          ...
          <span style={{ color: '#94a3b8', fontSize: '0.78rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 150, fontFamily: 'Georgia, serif' }}>
            {event?.title || 'New Flyer'}
          </span>

          <div style={{ width: 1, height: 28, background: '#334155', margin: '0 3px', flexShrink: 0 }} />

            {LANGUAGES.map(lang => {
              const active = activeLang === lang.code;
              return (
              <button key={lang.code} onClick={() => handleTranslate(lang.code)} disabled={translating} style={{
                padding: '5px 10px', border: `1.5px solid ${active ? '#fb923c' : '#334155'}`,
                background: active ? '#c2410c' : '#0f172a',
                color: active ? '#fff' : '#94a3b8', borderRadius: 6, cursor: 'pointer',
          ...
          <button onClick={() => setShowHistory(true)} style={{ padding: '5px 11px', background: '#0f172a', border: '1.5px solid #334155', color: '#94a3b8', borderRadius: 6, cursor: 'pointer', fontSize: '0.76rem', fontFamily: 'Georgia, serif' }}>🕐 History</button>
          <button onClick={handleSaveDraft} disabled={saving} style={{ padding: '5px 11px', background: '#0f172a', border: '1.5px solid #334155', color: '#94a3b8', borderRadius: 6, cursor: 'pointer', fontSize: '0.76rem', fontFamily: 'Georgia, serif' }}>💾 {saving ? 'Saving…' : 'Save Draft'}</button>
          <button onClick={handleSaveToS3} disabled={uploading} style={{ padding: '5px 11px', background: '#0f172a', border: '1.5px solid #334155', color: '#94a3b8', borderRadius: 6, cursor: 'pointer', fontSize: '0.76rem', fontFamily: 'Georgia, serif' }}>☁ {uploading ? 'Uploading…' : 'Save to Cloud'}</button>
          ...
          <div style={{ width: 1, height: 28, background: '#334155', margin: '0 2px', flexShrink: 0 }} />
          <button onClick={onClose} style={{ width: 32, height: 32, background: '#0f172a', border: '1.5px solid #334155', color: '#94a3b8', borderRadius: 6, cursor: 'pointer', fontSize: '0.85rem', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>✕</button>
