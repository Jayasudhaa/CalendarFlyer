    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(180deg, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0) 55%), linear-gradient(135deg,#4a4642,#000000)',
          borderRadius: '16px 16px 0 0',
        }}>
          <div>
            <div style={{ color: 'white', fontWeight: '800', fontSize: '1.2rem', fontFamily: "'Playfair Display', Georgia, serif" }}>
              📚 Flyer History
            </div>
                  ...
                  <div style={{ padding: '12px 14px' }}>
                    ...
                    <div style={{ display: 'flex', gap: 6, marginTop: 10 }}>
                      <button onClick={() => onLoad(draft)} style={{
                        flex: 1, padding: '7px',
                        background: 'linear-gradient(180deg, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0) 48%), linear-gradient(135deg,#57534e,#000000)',
