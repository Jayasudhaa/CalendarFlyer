...
# Set your real admin secret as an environment variable before running this script,
# e.g. $env:TEMPLE_ADMIN_SECRET = "your-real-secret"
Set-Content "$frontend\.env" "VITE_ADMIN_SECRET=$env:TEMPLE_ADMIN_SECRET"
