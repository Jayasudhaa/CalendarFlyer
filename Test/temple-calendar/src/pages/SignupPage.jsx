 ...
 * for an event and lets an email-verified devotee join/cancel a slot.
 * Same email-verification identity as PhotoSharePage.jsx (token stored
 ...
 * so the roster shows "Priya K." instead of an email address.
 *
...
// ── Email verification — identical pattern to PhotoSharePage.jsx's own ──
  ...
  return (
    <div style={{ background: '#fffdf7', borderRadius: 16, border: '1px solid #e8d5b7', padding: 28 }}>
      <div style={{ color: '#92400e', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: 20 }}>
        To join a shift or claim a dish, verify your email address — this keeps the sign-up list for people who are actually part of this community.
      </div>
