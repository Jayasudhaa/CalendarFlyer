        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {/* cf-shine-text gives each link the same shimmering-white
                ...
                instead of all five links flashing in lockstep. */}
            ...
            <button onClick={() => navigate('/blog')} className="cf-shine-text text-base font-bold hover:opacity-80 transition-opacity" style={{ animationDelay: '0.3s' }}>Blog</button>
            <button onClick={() => navigate('/about')} className="cf-shine-text text-base font-bold hover:opacity-80 transition-opacity" style={{ animationDelay: '0.6s' }}>About</button>
            ...
            <button onClick={() => navigate('/explore')} className="cf-shine-text text-base font-bold hover:opacity-80 transition-opacity" style={{ animationDelay: '1.2s' }}>
              Explore
            </button>
